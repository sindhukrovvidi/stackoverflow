describe("Cypress Tests repeated from React assignment", () => {
    beforeEach(() => {
      ...
      cy.get("#loginPageButton").contains('Login').click();
    ...
    it('1.1 | Adds three questions and one answer, then click "Questions", then click unanswered button, verifies the sequence', () => {
      ...
      cy.visit("http://localhost:3000/addQuestion");
    ...
    it("2.2 | Ask a Question creates and displays expected meta data", () => {
      ...
      cy.contains("sindhu asked 0 seconds ago");
      const answers = [
        "0 answers",
        "1 answers",
        "2 answers",
    ...
    it("6.1 | Checks if a6 and a7 exist in q3 answers page", () => {
      const answers = [
    ...
    it("6.2 | Checks if a8 exist in q4 answers page", () => {
      cy.visit("http://localhost:3000/questions");
