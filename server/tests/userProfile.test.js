...
describe("UserProfile Controller", () => {
  ...
  describe("POST /users/updateUser", () => {
    ...
    it("should return 404 if user is not found", async () => {
      ...
      expect(response.status).toBe(404);
      // expect(response.body.message).toBe("Userdata not found in session");
    });
    ...
    it("should update user details", async () => {
      ...
      const updatedUser = {
        ...
        contact_no: 5678,
        modifiedOn: modifiedOnDate
      };
    
      const findOneAndUpdateMock = jest.fn().mockResolvedValueOnce(updatedUser);
      User.findOneAndUpdate = findOneAndUpdateMock;
